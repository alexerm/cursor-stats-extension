...
interface AvgTokensBarChartProps {
  data: BarChartData[];
  theme: Record<string, unknown>;
}

const AvgTokensBarChart: React.FC<AvgTokensBarChartProps> = ({ data, theme }) => {
      ...
      tooltip={({ id, value, color, data }) => (
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            {formatTokenValue(value as number)} tokens/request
          </div>
        </div>
      )}
    />
...
export default AvgTokensBarChart;
